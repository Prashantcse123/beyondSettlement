            ...
            <TableFooter>
                <TableRow>
                    <TablePagination
                        ...
                        style={{borderTop: '1px solid lightgray', boxShadow: '0 0 10px lightgray'}}
                        ActionsComponent={() => <Paginate rows={count} currentPage={page + 1} perPage={rowsPerPage} onPageClick={this.handlePageChange} />}
                    />
                </TableRow>
            </TableFooter>
        );
